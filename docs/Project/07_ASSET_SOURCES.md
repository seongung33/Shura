...
| AI-A-012 | 척준경 캐릭터 선택 초상화 | OpenAI 이미지 생성·로컬 후처리 | 팀 제공 척준경 설정화를 참조한 고려 장군 × 2179년 사이버 전사, 흉상, 암철 갑옷, 적색 발광 문양, 대형 양손 대검, 고정 14색 16비트 JRPG 픽셀 아트 | 2026-08-10 | 초록 크로마키 제거, 512×512 최근접 축소, 지정 14색 재양자화, 이진 알파, Point 필터·무압축 Sprite 설정. 2차 시안에서 대검을 손으로 쥐고 어깨 옆에 세운 자세로 교정 | `Assets/_Project/Art/Characters/CheokJunGyeong/Profile/CheokJunGyeong_CharacterSelect_512_v2.png`, 캐릭터 선택 UI | 팀 |
| AI-A-013 | 척준경 오른쪽 기준 포즈 | OpenAI 이미지 생성·로컬 후처리 | 척준경 전신 오른쪽 측면, 약한 3/4 탑다운, 양손 대검 칼끝 아래, 192×192 프레임, 캐릭터 높이 108px, 고정 14색 픽셀 아트 | 2026-08-10 | 초록 크로마키 제거, 108px 최근접 축소, 192×192 투명 캔버스 바닥선 배치, 지정 14색 재양자화, 이진 알파, Point·PPU 96·Bottom 피벗 설정 | `Assets/_Project/Art/Characters/CheokJunGyeong/CheokJunGyeong_Idle_Right_192.png`, 척준경 애니메이션 기준 | 팀 |
| AI-A-014 | 척준경 오른쪽 걷기 8프레임 | OpenAI 이미지 생성·로컬 후처리 | 기준 포즈를 유지한 무거운 갑옷 보행, 접지·다운·패싱·업 좌우 반복, 대검·치마판·붉은 술 흔들림, 고정 14색 | 2026-08-10 | 마지막 프레임 잘림 보정 재생성, 초록 크로마키 제거, 프레임별 108px 정규화, 192×192 셀 8개 조립, 지정 14색 재양자화, 이진 알파, Point·PPU 96·Bottom 피벗 설정 | `Assets/_Project/Art/Characters/CheokJunGyeong/CheokJunGyeong_Walk_Right_8F_192.png`, 척준경 걷기 애니메이션 | 팀 |
| AI-A-015 | 척준경 철혈참 8프레임 | OpenAI 이미지 생성·로컬 후처리 | 오른쪽 두 손 수평 부채꼴 근접 베기, 대기·준비·전진·최대 신전·후속·회복, 본체와 대검만 표현하고 검기·에너지 FX 제외 | 2026-08-10 | 프레임 접촉 문제 보정 재생성, 초록 크로마키 제거, 프레임별 108px 정규화, 192×192 셀 8개 조립, 지정 14색 재양자화, 이진 알파, Point·PPU 96·Bottom 피벗 설정 | `Assets/_Project/Art/Characters/CheokJunGyeong/CheokJunGyeong_CheolhyeolSlash_Right_8F_192.png`, 철혈참 캐릭터 애니메이션 | 팀 |
| AI-A-016 | 척준경 철혈참 부채꼴 FX | OpenAI 이미지 생성·로컬 후처리 | 좌측 중앙에서 +X 방향으로 펼쳐지는 120도 3중 검격선, 속성 색 치환을 위한 순백색 알파 전용 픽셀 FX | 2026-08-10 | 초록 크로마키 제거, 256×256 Point 축소, 가시 픽셀 RGB `#FFFFFF` 강제, 알파 0/64/128/192/255 정리, PPU 256·Custom Pivot `(0, 0.5)`·무압축 Sprite 설정 | `Assets/_Project/Art/Combat/CheokJunGyeong/FX_CheolhyeolSlash_256.png`, `Skill_CheolhyeolSlash.prefab` | 팀 |
| AI-A-017 | 척준경 파진 돌진 궤적 FX | OpenAI 이미지 생성·로컬 후처리 | 왼쪽의 끊어진 잔상에서 오른쪽의 넓은 선두로 모이는 수평 쐐기형 검격과 중앙 절단선, 순백색 알파 전용 픽셀 FX | 2026-08-10 | 초록 크로마키 제거, 512×256 Point 축소, 가시 픽셀 RGB `#FFFFFF` 강제, 알파 0/64/128/192/255 정리, PPU 256·Center Pivot·무압축 Sprite 설정 | `Assets/_Project/Art/Combat/CheokJunGyeong/FX_Pajin_512x256.png`, `Skill_Pajin.prefab` | 팀 |
| AI-A-018 | 척준경 회천참 360도 링 FX | OpenAI 이미지 생성·로컬 후처리 | 네 변에 닿는 완전한 외곽 링과 한 바퀴 회전하는 내부 스트로크, 비어 있는 중심의 순백색 알파 전용 픽셀 FX | 2026-08-10 | 초록 크로마키 제거, 256×256 Point 축소, 가시 픽셀 RGB `#FFFFFF` 강제, 알파 0/64/128/192/255 정리, PPU 256·Center Pivot·무압축 Sprite 설정 | `Assets/_Project/Art/Combat/CheokJunGyeong/FX_Hwecheon_256.png`, `Skill_Hwecheon.prefab` | 팀 |
| AI-A-019 | 척준경 파성참 붕괴 충격 FX | OpenAI 이미지 생성·로컬 후처리 | 중앙 내려베기 충격점에서 외곽으로 뻗는 방사형 균열, 네 변에 닿는 충격파 링과 작은 파편의 순백색 알파 전용 픽셀 FX | 2026-08-10 | 초록 크로마키 제거, 256×256 Point 축소, 가시 픽셀 RGB `#FFFFFF` 강제, 알파 0/64/128/192/255 정리, PPU 256·Center Pivot·무압축 Sprite 설정 | `Assets/_Project/Art/Combat/CheokJunGyeong/FX_Paseong_256.png`, `Skill_Paseong.prefab` | 팀 |
| AI-A-020 | 척준경 검풍 관통 검기 FX | OpenAI 이미지 생성·로컬 후처리 | 오른쪽 볼록 칼날과 오목한 후면을 가진 세로 초승달형 압축 공기, 왼쪽으로 뻗는 두 줄의 바람 잔상으로 구성된 순백색 알파 전용 픽셀 FX | 2026-08-10 | 초록 크로마키 제거, 256×128 Point 축소, 가시 픽셀 RGB `#FFFFFF` 강제, 본체 255·주요 잔상 128·분절 64 알파 정리, PPU 256·Center Pivot·무압축 Sprite 설정 | `Assets/_Project/Art/Combat/CheokJunGyeong/FX_Geompung_256x128.png`, `Skill_Geompung.prefab` | 팀 |
| AI-A-021 | 척준경 혈로 지속 오라 FX | OpenAI 이미지 생성·로컬 후처리 | 네 변에 닿는 얇은 원형 링, 안쪽을 향한 짧은 칼날 눈금과 캐릭터 가독성을 보존하는 성긴 내부 회전선의 순백색 알파 전용 픽셀 FX | 2026-08-10 | 초록 크로마키 제거, 256×256 Point 축소, 가시 픽셀 RGB `#FFFFFF` 강제, 외곽 255·눈금 192·내부 64 알파 정리, PPU 256·Center Pivot·무압축 Sprite 설정 | `Assets/_Project/Art/Combat/CheokJunGyeong/FX_Hyeollo_256.png`, `Skill_Hyeollo.prefab` | 팀 |
| AI-A-022 | 척준경 일기당천 폭주 오라 FX | OpenAI 이미지 생성·로컬 후처리 | 조밀한 내부 링에서 외곽으로 솟는 각진 에너지 혀, 네 변에 닿는 압력 링과 캐릭터가 보이는 중앙 공간의 순백색 알파 전용 픽셀 FX | 2026-08-10 | 초록 크로마키 제거, 256×256 Point 축소, 가시 픽셀 RGB `#FFFFFF` 강제, 알파 0/64/128/192/255 정리, PPU 256·Center Pivot·무압축 Sprite 설정 | `Assets/_Project/Art/Combat/CheokJunGyeong/FX_Ilgidangcheon_256.png`, `Skill_Ilgidangcheon.prefab` | 팀 |
